...
System.out.println("2. Read 2 matrices from the console and perform matrix
addition.\n");
...
System.out.println("First Matrix:"); for(int i=0;i<p;i++)
{
for(int j=0;j<q;j++)
{
...
System.out.println("Matrix after addition:"); for(int i=0;i<p;i++)
{
for(int j=0;j<n;j++)
{
